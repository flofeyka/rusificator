    ...
    return <main className={"min-w-[95vw] sm:w-[100vw]"}>
        ...
        <div className={"mb-14"}>
            ...
            <motion.div initial={{left: -100, opacity: 0}}
                        animate={{fillOpacity: "revert-layer", right: -100, left: 0, opacity: 1}}
                ...
                <motion.div transition={{type: "string", delay: 1}} initial={{width: 0, opacity: 0}}
                            animate={{width: 260, opacity: 100}}
                ...
                <motion.div transition={{type: "just", delay: 1}} initial={{width: 0, opacity: 0}}
                            animate={{width: 260, opacity: 100}}
        ...
        <div
            className={"flex sm:flex-col w-[100vw] md:justify-center sm:w-screen sm:justify-center mx-auto items-center sm:items-center lg:justify-between sm:my-5"}>
            <div className={"w-[50vw] md:w-[35vw] justify-center flex"}>
                <motion.img alt={"Logo"}
                            className={"min-h-[40px] md:mr-14 md:pr-16 max-h-[80px] md:h-[70px] md:w-max sm:h-[50px] lg:mr-10"}
                            src={Zeekr}/>
            </div>
            <div className={"w-[50vw] md:w-[40vw] justify-center flex"}>
                <motion.img alt={"Logo"}
                            className={"min-h-[40px] lg:mr-10 sm:h-[100px] md:h-[130px] md:w-max max-h-[150px] md:ml-16 md:pl-14"}
                            src={Lixiang}/>
            </div>
        </div>
